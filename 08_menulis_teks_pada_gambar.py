...
# ★ KODE INTI ★ — Gunakan ini untuk menghitung posisi agar teks TEPAT di tengah
# Tanpa getTextSize, penempatan teks hanya bisa dikira-kira
...
# ★ KODE INTI ★ — Parameter org adalah posisi kiri-BAWAH teks, BUKAN kiri-atas!
# Ini berbeda dari konvensi gambar biasa (yang dimulai dari kiri-atas)
# Posisi y harus ditambah tinggi_teks agar teks tidak muncul di luar canvas
